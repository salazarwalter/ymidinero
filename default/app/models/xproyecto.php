 ...
 * 
 */
class Xproyecto extends ActiveRecord
{
...
public function initialize(){
	$this->validates_presence_of("proyecto_nombre",array("message"=>"Debe Ingresar el Nombre del Proyecto"));;
...
public function lista() {
    return $this->find("xusuario_id = ". Auth::get("id"));
}
}
 ?>